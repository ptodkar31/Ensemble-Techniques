# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 22:06:14 2024
...
1.With the development of living standards, diabetes is increasingly
common in people’s daily life. 
2.Therefore, how to quickly and accurately diagnose and analyze diabetes is a 
topic worthy studying. 
3.In medicine, the diagnosis of diabetes is according to fasting blood glucose,
glucose tolerance, and random blood glucose levels. 
4.The earlier diagnosis is obtained, the much easier we can control it.
5.Machine learning can help people make a preliminary judgment about diabetes
...
'''
df.describe()
#Number of times pregnant Average 3.845052
#Min: 0 
#Max:17.00
#Avearge age: 33.24 
#Min:21 
...
new_names=["Pregnancies","Glucose","BP","Skin_thickness",
           "Insulin","BMI","D_pedigree","Age","Outcome"]
df=pd.read_csv(
               "C:\Data Set\Diabeted_Ensemble.csv",
               names=new_names,
               header=0,
