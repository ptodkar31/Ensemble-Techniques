# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 22:06:34 2024

@author: Priyanka
"""
"""
1.Data privacy is always an important factor to safeguard 
...
1.Passwords are undoubtedly essential to security,but they are not the only
method that can or should be used to protect one's computers and devices.
2.In addition to creating a good password, people should learn how to safeguard 
it and use it wisely.
3.This means never sharing it and, if unable to remember it, 
...
import numpy as np
df=pd.read_excel("C:/Data Set/Ensemble_Password_Strength.xlsx")
df.dtypes
'''
characters              object
