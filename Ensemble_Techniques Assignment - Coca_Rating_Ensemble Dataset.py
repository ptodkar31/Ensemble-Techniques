...
3.Finally, it will show us how geographic factors
...
import numpy as np
df=pd.read_csv("C:\Data Set\Coca_Rating_Ensemble.csv")
df.dtypes
'''
Company              object
Name                 object
...
df.describe()
# REF Average:1035.904735
#Min: 5 
#Max is 1952
#Review Avearge: 2012.325348
#Min:2006
#Max is 2017
#The average percent of cocoa in a chocolate bar is around 70%, 
#and the average rating that consumers are giving to chocolate bars is 3.1
